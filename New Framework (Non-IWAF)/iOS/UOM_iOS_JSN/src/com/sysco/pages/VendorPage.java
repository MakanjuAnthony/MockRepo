...
public class VendorPage extends JSN_Framework {
	...
	public static final String ADD_VendorDelete = "//UIAButton[@label='Delete Supplier']";
	public static final String Delete_Yes = 	"//UIAButton[@label='Yes, Delete']";
	public static final String Delete_Cancel = "//UIAButton[@label='No, Cancel']";
	...
	public VendorPage Add_Supplier(String string) throws InterruptedException, IOException {
		...
		try {
			waitForElementPresent(ADD_Vendor);
			...
			waitForElementPresent(ADD_VendorPage);
	...
	public VendorPage TapOnDone(String string) throws InterruptedException, IOException {
		...
		try {
			...
			Set<String> contextNames = ((IOSDriver) driver)
					.getContextHandles();

			for (String contextName : contextNames) {
				System.out.println(contextNames);
			}
			System.out.println(((IOSDriver) driver)
		...
		try {
			...
			final String VD_Vendorname = 
					"//*[@id='list-item']//*[contains(text(),'" + vendorName
							+ "')]";
			waitForElementPresent(VD_Vendorname);
	...
	public VendorPage ViewSupplierDetails_Android(String name, String number,
			String address, String contactinfo, String email, String note,
			String string) throws InterruptedException, IOException {
		String string1 = "Success";
		String string2 = "Issue";
	...
	public VendorPage DeleteSupplier(String string) throws InterruptedException, IOException {
		...
		try {
			...
			waitForElementPresent(ADD_VendorDelete);
			...
			waitForElementPresent(Delete_Yes);
...
switchToWebContext();
	...
	public VendorPage AddSupplier_Details(String name, String number,
		...
		try {
			...
			waitForElementPresent(ADD_VendorNameLabel);
			waitForElementPresent(ADD_VendorName);
			...
			waitForElementPresent(ADD_VendorNumberLabel);
			...
			waitForElementPresent(ADD_VendorAddressLabel);
			...
			waitForElementPresent(ADD_VendorContactInfoLabel);
			...
			waitForElementPresent(ADD_VendorEmailLabel);
			...
			waitForElementPresent(ADD_VendorNoteLabel);
