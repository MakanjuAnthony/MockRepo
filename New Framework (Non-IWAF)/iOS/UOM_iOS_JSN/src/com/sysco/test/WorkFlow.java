...
public class WorkFlow extends JSN_Framework{
	...
	public  void setUp() throws Exception{
		...
		capabilities.setCapability("deviceName", "Sysco Galaxy S6");
		capabilities.setCapability("app", "/Users/naveen_raj04/Desktop/UOM_Files/Builds/july 27/UOMQA_SQ-debug-7.apk");
		driver = new AndroidDriver(new URL("http://10.155.162.74:4723/wd/hub"), capabilities);
	...
	public  void setUp() throws Exception{
		...
		capabilities.setCapability("deviceName", "Sysco-iPhone 6");
		capabilities.setCapability("app", "/Users/sujina_s/Desktop/Sysco/July/july27/UOMQASQ.ipa");
		driver = new IOSDriver(new URL("http://10.155.106.25:4723/wd/hub"), capabilities);
		driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);  
		switchToWebContext();	
	}
	@AfterMethod
	...
	public void SI_WF7_OG_DefaultLocation_SkipCategory() throws Exception {
		...
		locationsPage.AddLocationCooler("SI - WF 7-Tapped Cooler");
...
user=10;
		...
		locationsPage.AddLocation_AddProductDetailsPage("Tap Add location");
		setupInventoryPage.SelectLocation_PdtCard(datapool.readFromExcelLocationInfo().locationNameDataPool[2], "Location selected");
		...
		locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[2], "MNS-1-Select added location");///
		...
		public void FC_WF1_OG_CustomLoc_DefaultCategory_TrackInventory_FoodCost()  throws Exception 
		{
		
		//	LocationsData locationsData1 =LocationsData.fetch("LocationsData");    datapool.readFromExcelLocationInfo().locationNameDataPool[2]
		//	LocationsData locationsData2 =LocationsData.fetch("LocatiosData1");     datapool.readFromExcelLocationInfo().locationNameDataPool[3]
		//	UOMQuantityData uomQuantityData=UOMQuantityData.fetch("UOMQuantityData"); datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2]
		//	UOMQuantityData uomQuantityData1=UOMQuantityData.fetch("UOMQuantityData2"); datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0]
		//	UOMQuantityData uomQuantityData2=UOMQuantityData.fetch("UOMQuantityData3"); datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[4]
		//	PurchasesData purchasesData=PurchasesData.fetch("PurchasesData"); datapool.readFromExcelPurchasesInfo().purchasesDataPool[0],datapool.readFromExcelPurchasesInfo().purchasesDataPool[1],
		//	NonSyscoItemData nonSyscoItemData =NonSyscoItemData.fetch("NonSyscoItmData"); datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[7] to 13
		//	VendorDetailsData vendorDetailsData =VendorDetailsData.fetch("VDNonsysco");
		//	NonSyscoItemData nonSyscoItemData1 =NonSyscoItemData.fetch("NonSyscoItmData1");datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[14] to 20
		//	LocationsData locDataCooler=LocationsData.fetch("LocatiosData5");   (datapool.readFromExcelLocationInfo().locationNameDataPool[6]
		//	LocationsData locDataFreezer=LocationsData.fetch("LocatiosData6"); (datapool.readFromExcelLocationInfo().locationNameDataPool[7]
		//	LocationsData  locDataDry=LocationsData.fetch("LocatiosData7");  (datapool.readFromExcelLocationInfo().locationNameDataPool[8]
			
			
			
			user=8;
			
			loginPage.verifyLoginPage("FC-WF1-LoginPage");
			loginPage.signIn(datapool.readFromExcelUserInfo().userNameDataPool[user],datapool.readFromExcelUserInfo().passwordDataPool[user],"FC-WF1-LoginPage");
			homePage.ClickAccount(datapool.readFromExcelUserInfo().userNameDataPool[user],"Clicked account");
			accountsPage.Fourth_AccountSelection(datapool.readFromExcelUserInfo().userNameDataPool[user],"FC-WF1-FirstAccountSelect");

		
			inventoryToolPage.InvTools_SetUpInventory("FC-WF1-SetupInventoryTap");
			setupInventoryPage.TapOnSkip("FC-WF1-Skip1 Tapped");
			setupInventoryPage.TapOrderGuide("FC-WF1-OG Selected");
			setupInventoryPage.tapContinue("FC-WF1-Tapped Continue");

			
			locationsPage.CustomLocation("FC-WF1-Tapped Custom location");
			locationsPage.tapContinue("FC-WF1-Tapped Continue2");

			locationsPage.EnterLocationName(datapool.readFromExcelLocationInfo().locationNameDataPool[2],"FC-WF1-Enter location name");
			locationsPage.AddLocations1_TypeDry("FC-WF1-Tapped Dry1");

			locationsPage.AddLocations2("FC-WF1-Entering another location");
			locationsPage.AddLocations2_name(datapool.readFromExcelLocationInfo().locationNameDataPool[3],"FC-WF1-Enter location name");
			locationsPage.AddLocations2_TypeDry("FC-WF1-Tapped Dry2");
			locationsPage.TapOnNext("FC-WF1-Tapped Next1");

			locationsPage.selectMultipleItemsFromLocation1("FC-WF1-Selected Multiple items");
			locationsPage.TapOnNext("FC-WF1-Tapped Next2");

			locationsPage.selectMultipleItemsFromLocation2("FC-WF1-Selected Multiple items");
			locationsPage.TapOnDone("FC-WF1-Tapped Done1");

			
			categoryPage.defaultCategories("FC-WF1-Tapped Default category");
			categoryPage.tapComplete("FC-WF1-Tapped Complete");
			setupInventoryPage.TapTakeHome("FC-WF1-Tapped take me home")  ; 
	...
	//adding nonsyscoitem with nonfood category 
			...
			*/
			...
			inventoryToolPage.InvTools_TrackInventory("FC-WF1-Selected track inventory");

					
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[2], "FC-WF1-Selected cooler");
			locationsPage.ProductQtyEnter(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF1-Entering Quantity1");
			locationsPage.TapOnDone("FC-WF1-Tapped done");
			locationsPage.TapOnBack("FC-WF1-Tapped on Back");
				
					
			inventoryToolPage.InvTools_CloseInventory("FC-WF1-Tapped close inventory");
			inventoryToolPage.InvTools_ClosedInventoryYes("FC-WF1-Tapped Yes,Close");
			...
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[2], "FC-WF1-Selected cooler");
			locationsPage.SelectItemFromLocations("FC-WF1-Selected first product");
			locationsPage.TapOnEdit("FC-WF1-Tapped edit");
			locationsPage.PdtDetailPage_Location1_EnterQty(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[4], datapool.readFromExcelLocationInfo().locationNameDataPool[6], "FC-WF1-Edited qty");
			locationsPage.TapOnDone("FC-WF1-Tapped done");
			locationsPage.TapOnBack("FC-WF1-Tapped on Back");
			locationsPage.TapOnBack("FC-WF1-Tapped on Back");
			locationsPage.TapOnBack("FC-WF1-Tapped on Back");
			...
			inventoryToolPage.InvTools_FoodCost("FC-WF1-Tapped food cost");
					
					
			foodCostPage.VerifyNetPurchases("FC-WF1-Verify net purchase value");
			foodCostPage.VerifyCostOfGoodsSold("FC-WF1-Verify cost of goods sold value");
			foodCostPage.EnterRevenue(datapool.readFromExcelPurchasesInfo().purchasesDataPool[6], "FC-WF1-Entered Revenue");
			foodCostPage.CalculateFoodCost("FC-WF1-Calculated food cost");
		...
		public void FC_WF3_OG_CustomLoc_SuggestedCategory_TrackInventory_FoodCost() throws Exception
		{
			
		//	LocationsData locationsData1 =LocationsData.fetch("LocationsData"); datapool.readFromExcelLocationInfo().locationNameDataPool[2]
//			LocationsData locationsData2 =LocationsData.fetch("LocatiosData1");  datapool.readFromExcelLocationInfo().locationNameDataPool[3]
		//	UOMQuantityData uomQuantityData=UOMQuantityData.fetch("UOMQuantityData"); datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0]
		//	UOMQuantityData uomQuantityData1=UOMQuantityData.fetch("UOMQuantityData2"); datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2]
		//	PurchasesData purchasesData=PurchasesData.fetch("PurchasesData");
		//	NonSyscoItemData nonSyscoItemData =NonSyscoItemData.fetch("NonSyscoItmData"); datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[14]
		//	VendorDetailsData vendorDetailsData =VendorDetailsData.fetch("VDNonsysco");
		//	NonSyscoItemData nonSyscoItemData1 =NonSyscoItemData.fetch("NonSyscoItmData1");
			
	user=8;
			
			loginPage.verifyLoginPage("FC-WF3-LoginPage");
			loginPage.signIn(datapool.readFromExcelUserInfo().userNameDataPool[user],datapool.readFromExcelUserInfo().passwordDataPool[user],"FC-WF3-LoginPage");
			homePage.ClickAccount(datapool.readFromExcelUserInfo().userNameDataPool[user],"FC-WF3-Clicked account");
			accountsPage.Fourth_AccountSelection(datapool.readFromExcelUserInfo().userNameDataPool[user],"FC-WF3-FirstAccountSelect");

		
			inventoryToolPage.InvTools_SetUpInventory("FC-WF3-SetupInventoryTap");

			
			setupInventoryPage.TapOnSkip("FC-WF3-Skip1 Tapped");

			setupInventoryPage.TapOrderGuide("FC-WF3-OG Selected");
			setupInventoryPage.tapContinue("FC-WF3-Tapped Continue");

			
			locationsPage.CustomLocation("FC-WF3-Tapped Custom location");
			locationsPage.tapContinue("FC-WF3-Tapped Continue2");

			locationsPage.EnterLocationName(datapool.readFromExcelLocationInfo().locationNameDataPool[2],"FC-WF3-Enter location name");
			locationsPage.AddLocations1_TypeDry("FC-WF3-Tapped Dry1");

			locationsPage.AddLocations2("");
			locationsPage.AddLocations2_name(datapool.readFromExcelLocationInfo().locationNameDataPool[3],"");
			locationsPage.AddLocations2_TypeDry("FC-WF3-Tapped Dry2");
			locationsPage.TapOnNext("FC-WF3-Tapped Next1");

			locationsPage.selectMultipleItemsFromLocation1("FC-WF3-Selected Multiple items");
			locationsPage.TapOnNext("FC-WF3-Tapped Next2");

			locationsPage.selectMultipleItemsFromLocation2("FC-WF3-Selected Multiple items");
			locationsPage.TapOnDone("FC-WF3-Tapped Done1");

			
			categoryPage.SuggestedCategories("FC-WF3-SuggestedCategories Tapped");
			categoryPage.tapContinue("FC-WF3-Tapped Continue3");


			setupInventoryPage.TapTakeHome("FC-WF3-Tapped take me home")   ;

	    
			//inv_274,276
			
			
			inventoryToolPage.InvTools_TrackInventory("FC-WF3-Selected track inventory");
			
	//adding nonsyscoitem with nonfood category 
		
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[2], "FC-WF3-Selected cooler");
			locationsPage.TapAddLocation("FC-WF3-Tapped ADD");
		
			setupInventoryPage.AddItemFrom_NonSysco("FC-WF3-Tapped NonSysco");
			setupInventoryPage.EnterItemDetails(datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[0], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[1], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[2], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[3], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[4], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[5],datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[6], "FC-WF3-NonSyscoItem details entered");
			setupInventoryPage.AddSupplier_AddProductDetailsPage("FC-WF3-select supplier");
		
			vendorPage.Add_Supplier("FC-WF3-AddVendorTap");
			vendorPage.AddSupplier_Details(datapool.readFromExcelSupplier2Info().supplier2DataPool[0], datapool.readFromExcelSupplier2Info().supplier2DataPool[1], datapool.readFromExcelSupplier2Info().supplier2DataPool[2], datapool.readFromExcelSupplier2Info().supplier2DataPool[3], datapool.readFromExcelSupplier2Info().supplier2DataPool[4], datapool.readFromExcelSupplier2Info().supplier2DataPool[5], "FC-WF3-AddVendorDetails");
			vendorPage.TapOnDone("FC-WF3-Done");
			vendorPage.TapOnBack("FC-WF3-Back");
			vendorPage.SupplierSelect(datapool.readFromExcelSupplier2Info().supplier2DataPool[0],"FC-WF3-SupplierSelect");
		
			locationsPage.AddCategory_AddProductDetailsPage("FC-WF3-CategorySelect");
		
			categoryPage.SelectCategory(datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[21], "FC-WF3-Select Category Name");
			categoryPage.TapOnDone("FC-WF3-Tapped done");
			categoryPage.TapOnBack("FC-WF3-Tapped back");
		
			//adding nonsyscoitem with food category 
				
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[3], "FC-WF3-Selected cooler");
			locationsPage.TapAddLocation("FC-WF3-Tapped ADD");
					
			setupInventoryPage.AddItemFrom_NonSysco("FC-WF3-Tapped NonSysco");
			setupInventoryPage.EnterItemDetails(datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[7], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[8], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[9], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[10], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[11], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[12], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[13], "FC-WF3-NonSyscoItem details entered");
			setupInventoryPage.AddSupplier_AddProductDetailsPage("FC-WF3-select supplier");
			...
			categoryPage.SelectCategory(datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[23], "FC-WF3-Select Category Name");
			categoryPage.TapOnDone("FC-WF3-Tapped done");
			categoryPage.TapOnBack("FC-WF3-Tapped back")	;
			
			
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[2], "FC-WF3-Selected cooler");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[1],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF3-Entering Quantity1 to food item");
			locationsPage.TapOnDone("FC-WF3-Tapped done");
					
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[3], "FC-WF3-Selected cooler");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[8],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF3-Entering Quantity1 to food item");
			locationsPage.TapOnDone("FC-WF3-Tapped done");
					
			locationsPage.TapOnBack("FC-WF3-Tapped on Back");
			
			inventoryToolPage.InvTools_CloseInventory("FC-WF3-Tapped close inventory");
			inventoryToolPage.InvTools_ClosedInventoryYes("FC-WF3-Tapped Yes,Close");
	...
	/*
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[2], "FC-WF1-Selected cooler");
			locationsPage.ProductSelect(datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[0], "FC-WF1-Selected product");
			locationsPage.TapOnEdit("FC-WF1-Tapped on edit");
			locationsPage.PdtDetailPage_Location1_EnterQty(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2], datapool.readFromExcelLocationInfo().locationNameDataPool[2], "FC-WF1-Edited qty");
			locationsPage.TapOnDone("FC-WF1-Tapped done");
			locationsPage.TapOnBack("FC-WF1-Tapped on Back");
			locationsPage.TapOnBack("FC-WF1-Tapped on Back");*/
			
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[3], "FC-WF1-Selected cooler");
			locationsPage.ProductSelect(datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[7], "");
			locationsPage.TapOnEdit("FC-WF1-Tapped on edit");
			locationsPage.PdtDetailPage_Location1_EnterQty(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2], datapool.readFromExcelLocationInfo().locationNameDataPool[3], "FC-WF1-Edited qty");
			locationsPage.TapOnDone("FC-WF1-Tapped done");
			locationsPage.TapOnBack("FC-WF1-Tapped on Back");
			locationsPage.TapOnBack("FC-WF1-Tapped on Back");
			...
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[2], "FC-WF3-Selected cooler");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[1],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2],"FC-WF3-Entering Quantity1 to food item");
			locationsPage.TapOnDone("FC-WF3-Tapped done");
					
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[3], "FC-WF3-Selected cooler");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[8],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2],"FC-WF3-Entering Quantity1 to food item");
			locationsPage.TapOnDone("FC-WF3-Tapped done");
			...
			inventoryToolPage.InvTools_FoodCost("FC-WF3-Tapped food cost");
			
			foodCostPage.VerifyBeginningInventory(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[12], "FC-WF3-Verify beginning inventory value");
			foodCostPage.VerifyEndingInventory(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2], datapool.readFromExcelNonSyscoItemInfo().nonSyscoItemDataPool[12], "FC-WF3-Verify ending inventory value");
			foodCostPage.VerifyNetPurchases("FC-WF3-Verify net purchase value");
			foodCostPage.VerifyCostOfGoodsSold("FC-WF3-Verify cost of goods sold value");
			foodCostPage.EnterRevenue(datapool.readFromExcelPurchasesInfo().purchasesDataPool[6], "FC-WF3-Entered Revenue");
			foodCostPage.CalculateFoodCost("FC-WF3-Calculated food cost");
		...
		public void FC_WF2_OG_DefaultLoc_CustomCategory_TrackInventory_FoodCost() throws Exception
		{
...
//			LocationsData  locDataDry=LocationsData.fetch("LocatiosData7");
		...
		//	PurchasesData purchasesData=PurchasesData.fetch("PurchasesData");
			...
			loginPage.verifyLoginPage("FC-WF2-LoginPage");
			loginPage.signIn(datapool.readFromExcelUserInfo().userNameDataPool[user],datapool.readFromExcelUserInfo().passwordDataPool[user],"FC-WF2-LoginPage");
			homePage.ClickAccount(datapool.readFromExcelUserInfo().userNameDataPool[user],"FC-WF2-Clicked account");
			accountsPage.Fourth_AccountSelection(datapool.readFromExcelUserInfo().userNameDataPool[user],"FC-WF2-FirstAccountSelect");
			
			
			inventoryToolPage.InvTools_SetUpInventory("FC-WF2-SetupInventoryTap");

			setupInventoryPage.TapOnSkip("FC-WF2-Skip1 Tapped");

			setupInventoryPage.TapOrderGuide("FC-WF2-OG Selected");
			setupInventoryPage.tapContinue("FC-WF2-Tapped Continue");

		
			locationsPage.DefaultLocation("FC-WF2-Tapped Custom location");
			locationsPage.tapContinue("FC-WF2-Tapped Continue");

			
			categoryPage.CustomCategories("FC-WF2-CustomCategories Tapped");
			categoryPage.tapContinue("FC-WF2-Tapped Continue");
			categoryPage.VerifyOptionsOnCreateExpenseCategory("FC-WF2-Verified create custom category Page");
			
			categoryPage.CreateTwoExpenseCategory(datapool.readFromExcelCategoryInfo().categoryNameDataPool[1], datapool.readFromExcelCategoryInfo().categoryNameDataPool[2], "FC-WF2-CreateTwoExpenseCategory");
			categoryPage.TapOnNext("FC-WF2-Tapped Next");
			categoryPage.selectMultipleItemsFromCategory1("FC-WF2-selectMultipleItemsFromCategory1");
			categoryPage.TapOnNext("FC-WF2-Tapped Next");
			categoryPage.selectMultipleItemsFromCategory2("FC-WF2-selectMultipleItemsFromCategory2");

		
			setupInventoryPage.TapTakeHome("FC-WF2-Tapped take me home")   ;
	  
			//inv_123,121 OG+Defaultloc+custom category--
			
			inventoryToolPage.InvTools_TrackInventory("FC-WF2-Selected track inventory");

			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[6], "FC-WF2-Selected cooler");
			locationsPage.ProductQtyEnter(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF2-Entering Quantity1");
			locationsPage.TapOnDone("FC-WF2-Tapped done");
			locationsPage.TapOnBack("FC-WF2-Tapped on Back");
		
			inventoryToolPage.InvTools_CloseInventory("FC-WF2-Tapped close inventory");
			inventoryToolPage.InvTools_ClosedInventoryYes("FC-WF2-Tapped Yes,Close");
			...
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[6], "FC-WF2-Selected cooler");
			locationsPage.SelectItemFromLocations("FC-WF2-Selected first product");
			locationsPage.TapOnEdit("FC-WF2-Tapped edit");
			locationsPage.PdtDetailPage_Location1_EnterQty(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2], datapool.readFromExcelLocationInfo().locationNameDataPool[6], "FC-WF2-Edited qty");
			locationsPage.TapOnDone("FC-WF2-Tapped done");
			locationsPage.TapOnBack("FC-WF2-Tapped on Back");
			locationsPage.TapOnBack("FC-WF2-Tapped on Back");
			locationsPage.TapOnBack("FC-WF2-Tapped on Back");
			...
			inventoryToolPage.InvTools_FoodCost("FC-WF2-Tapped food cost");
		
			foodCostPage.VerifyNetPurchases("FC-WF2-Verify net purchase value");
			foodCostPage.VerifyCostOfGoodsSold("FC-WF2-Verify cost of goods sold value");
			foodCostPage.EnterRevenue(datapool.readFromExcelPurchasesInfo().purchasesDataPool[6], "FC-WF2-Entered Revenue");
			foodCostPage.CalculateFoodCost("FC-WF2-Calculated food cost");
		...
		public void FC_WF4_CustomList_DefaultLoc_CustomCategory_TrackInventory_FoodCost() throws Exception
		{
		...
		//	ListData listData=ListData.fetch("ListData5");
			...
			inventoryToolPage.InvTools_SetUpInventory("FC-WF4-SetupInventoryTap");
			setupInventoryPage.TapOnSkip("FC-WF4-Skip2 Tapped");

			listPage.TapCustomList("FC-WF4-custom list Selected");
			listPage.tapContinue("FC-WF4-Tapped Continue1");
			listPage.SelectListwithItems(datapool.readFromExcelList6Info().list6DataPool[0], "FC-WF4-select list");
			listPage.TapOnNext("FC-WF4-tapped next");

			locationsPage.DefaultLocation("FC-WF4-Tapped Custom location");
			locationsPage.tapContinue("FC-WF4-Tapped Continue");

			
			setupInventoryPage.TapOnSkip("FC-WF4-Skip1 Tapped");

			categoryPage.CustomCategories("FC-WF4-Custom Categories Tapped");
			categoryPage.tapContinue("FC-WF4-Tapped Continue3");
			categoryPage.CreateTwoExpenseCategory(datapool.readFromExcelCategoryInfo().categoryNameDataPool[1], datapool.readFromExcelCategoryInfo().categoryNameDataPool[2], "FC-WF4-CreateTwoExpenseCategory");
			categoryPage.TapOnNext("FC-WF4-Tapped Next3");
			categoryPage.selectMultipleItemsFromCategory1("FC-WF4-selectMultipleItemsFromCategory1");
			categoryPage.TapOnNext("FC-WF4-Tapped Next4");
			categoryPage.selectMultipleItemsFromCategory2("FC-WF4-selectMultipleItemsFromCategory2");
			
			setupInventoryPage.TapOnDone("FC-WF4-Tapped Done2");

			setupInventoryPage.TapTakeHome("FC-WF4-Tapped Continue3")  ; 

			inventoryToolPage.InvTools_TrackInventory("FC-WF4-Selected track inventory");
		
			//inv_117,119 
		
		
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[8], "FC-WF4-Selected cooler");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[1],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF4-Entering Quantity1 to food item");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[2],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF4-Entering Quantity1 to food item");
			locationsPage.TapOnDone("FC-WF4-Tapped done");
			
		    locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[7], "FC-WF4-Selected cooler");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[1],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF4-Entering Quantity1 to food item");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[2],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF4-Entering Quantity1 to food item");
			locationsPage.TapOnDone("FC-WF4-Tapped done");
			
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[6], "FC-WF4-Selected cooler");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[1],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF4-Entering Quantity1 to food item");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[2],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF4-Entering Quantity1 to food item");
			
			locationsPage.TapOnDone("FC-WF4-Tapped done");
			locationsPage.TapOnBack("FC-WF4-Tapped on Back");
		
			
			inventoryToolPage.InvTools_CloseInventory("FC-WF4-Tapped close inventory");
			inventoryToolPage.InvTools_ClosedInventoryYes("FC-WF4-Tapped Yes,Close");
		
			inventoryToolPage.InvTools_TrackInventory("FC-WF4-Selected track inventory");
		
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[8], "FC-WF4-Selected cooler");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[1],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2],"FC-WF4-Entering Quantity1 to food item");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[2],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2],"FC-WF4-Entering Quantity1 to food item");
			locationsPage.TapOnDone("FC-WF4-Tapped done");
			...
			inventoryToolPage.InvTools_CloseInventory("FC-WF4-Tapped close inventory");
			inventoryToolPage.InvTools_ClosedInventoryYes("FC-WF4-Tapped Yes,Close");
			inventoryToolPage.InvTools_FoodCost("FC-WF4-Tapped food cost");
			
			//	price validation
			foodCostPage.VerifyBeginningInventory(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0], datapool.readFromExcelList6Info().list6DataPool[3], "FC-WF4-Verify Beginning inventory value");
			foodCostPage.VerifyEndingInventory(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2], datapool.readFromExcelList6Info().list6DataPool[3], "FC-WF4-Verify Ending inventory value");
		     foodCostPage.VerifyNetPurchases("FC-WF4-Verify net purchase value");
			foodCostPage.VerifyCostOfGoodsSold("FC-WF4-Verify cost of goods sold value");
			foodCostPage.EnterRevenue(datapool.readFromExcelPurchasesInfo().purchasesDataPool[6], "FC-WF4-Entered Revenue");
			foodCostPage.CalculateFoodCost("FC-WF4-Calculated food cost");
		...
		public void FC_WF5_CustomList_CustomLoc_DefaultCategory_TrackInventory_FoodCost() throws Exception
		{
		...
		accountsPage.Fourth_AccountSelection(datapool.readFromExcelUserInfo().userNameDataPool[user],"FC-WF4-FirstAccountSelect");
			...
			inventoryToolPage.InvTools_SetUpInventory("FC-WF5-SetupInventoryTap");

			setupInventoryPage.TapOnSkip("FC-WF5-Skip2 Tapped");

			
			listPage.TapCustomList("FC-WF5-custom list Selected");
			listPage.tapContinue("FC-WF5-Tapped Continue1");
			listPage.SelectListwithItems(datapool.readFromExcelList6Info().list6DataPool[0], "FC-WF5-select list");
			listPage.TapOnNext("FC-WF5-tapped next");

			locationsPage.CustomLocation("FC-WF5-Tapped Custom location");
			locationsPage.tapContinue("FC-WF5-Tapped Continue2");

			locationsPage.EnterLocationName(datapool.readFromExcelLocationInfo().locationNameDataPool[2],"FC-WF5-Enter location name");
			locationsPage.AddLocations1_TypeDry("FC-WF5-Tapped Dry1");

			locationsPage.AddLocations2("");
			locationsPage.AddLocations2_name(datapool.readFromExcelLocationInfo().locationNameDataPool[3],"");
			locationsPage.AddLocations2_TypeDry("FC-WF5-Tapped Dry2");
			locationsPage.TapOnNext("FC-WF5-Tapped Next1");

			locationsPage.selectMultipleItemsFromLocation1("FC-WF5-Selected Multiple items");
			locationsPage.TapOnNext("FC-WF5-Tapped Next2");

			locationsPage.selectMultipleItemsFromLocation2("FC-WF5-Selected Multiple items");
			locationsPage.TapOnDone("FC-WF5-Tapped Done1");

			
			categoryPage.defaultCategories("FC-WF5-Tapped Default category");
			categoryPage.tapComplete("FC-WF5-Tapped Complete");
		
			setupInventoryPage.TapTakeHome("FC-WF5-Tapped Continue3")  ; 


			inventoryToolPage.InvTools_TrackInventory("FC-WF5-Selected track inventory");
		
			//inv_278,280
		
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[2], "FC-WF5-Selected cooler");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[1],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF5-Entering Quantity1 to food item");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[2],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF5-Entering Quantity1 to food item");
			locationsPage.TapOnDone("FC-WF5-Tapped done");
			
			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[3], "FC-WF5-Selected cooler");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[1],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF5-Entering Quantity1 to food item");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[2],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0],"FC-WF5-Entering Quantity1 to food item");
			locationsPage.TapOnDone("FC-WF5-Tapped done");
			
			locationsPage.TapOnBack("FC-WF5-Tapped on Back");
		
		
			inventoryToolPage.InvTools_CloseInventory("FC-WF5-Tapped close inventory");
			inventoryToolPage.InvTools_ClosedInventoryYes("FC-WF5-Tapped Yes,Close");
			
			inventoryToolPage.InvTools_TrackInventory("FC-WF5-Selected track inventory");

			locationsPage.SelectLocation(datapool.readFromExcelLocationInfo().locationNameDataPool[2], "FC-WF5-Selected cooler");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[1],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2],"FC-WF5-Entering Quantity1 to food item");
			locationsPage.ItemQtyEnterById(datapool.readFromExcelList6Info().list6DataPool[2],datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2],"FC-WF5-Entering Quantity1 to food item");
			locationsPage.TapOnDone("FC-WF5-Tapped done");
			...
			inventoryToolPage.InvTools_FoodCost("FC-WF5-Tapped food cost");
			
			//	price validation
			foodCostPage.VerifyBeginningInventory(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[0], datapool.readFromExcelList6Info().list6DataPool[3], "FC-WF5-Verify Beginning inventory value");
			foodCostPage.VerifyEndingInventory(datapool.readFromExcelUOMQuantityInfo().uomQuantityDataPool[2],datapool.readFromExcelList6Info().list6DataPool[3], "FC-WF5-Verify Ending inventory value");
			foodCostPage.VerifyNetPurchases("FC-WF5-Verify net purchase value");
			foodCostPage.VerifyCostOfGoodsSold("FC-WF5-Verify cost of goods sold value");
			foodCostPage.EnterRevenue(datapool.readFromExcelPurchasesInfo().purchasesDataPool[6], "FC-WF5-Entered Revenue");
			foodCostPage.CalculateFoodCost("FC-WF5-Calculated food cost");
		...
		public void FC_WF6_CustomList_CustomLoc_SuggestedCategory_TrackInventory_FoodCost() throws Exception
		{
