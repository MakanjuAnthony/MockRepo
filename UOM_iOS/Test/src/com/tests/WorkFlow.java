...
public class WorkFlow extends Initiator{
	 ...
	 */
	@Test(groups={"SI - WF 1"},priority=4, description = "SI - WF 2-TC2-OG + Dafault Loc + Default Category")
	 ...
	 * Prerequisite:Normal/MA User with OG items.
	 */
	@Test(groups={"SI - WF 3"},priority=0, description = "SI - WF 3-TC1-OG + Cus Loc + Cust Category")
	 ...
	 * Prerequisite:Normal/MA User with OG items.
	 */
	@Test(groups={"SI - WF 4"},priority=4, description = "SI - WF 4-TC1-OG + Default Loc + Custom Category ")
	...
	@Test(groups={"SI - WF 5"},priority=4, description = "SI - WF 5-TC1-OG + Custom Loc + Default Category")
	...
	@Test(groups={"SI - WF 6"},priority=0, description = "SI - WF 6-TC1-OG + Skip Loc + Skip Cust")
	 ...
	 * Prerequisite:Normal/MA User with OG items.
	 */
	@Test(groups={"SI - WF 7"},priority=0, description = "SI - WF 7-TC2-OG+Default loc + Skip Category")
	 ...
	 * Prerequisite:Normal/MA User with OG items.
	 */
	@Test(groups={"SI - WF 8"},priority=4, description = "SI - WF 8-TC1-OG + Skip Loc + Default Category ")
	...
	@Test(groups={"SI - WF 9"},priority=0, description = "SI - WF 9-TC2-Start From Scratch + add items from Product catelog +Default Loc + Default Category")
	...
	@Test(groups={"SI - WF 10"},priority=1, description = "SI - WF 10-TC1-Start From Scratch + add items from Order Guide +Default Loc + Default Category ")
	...
	@Test(groups={"SI - WF 11"},priority=3, description = "SI - WF 11-TC1-Start From Scratch + add items Non-sysco & Prep+Default Loc + Default Category")
	...
	@Test(groups={"SI - WF 12"},priority=3, description = "SI - WF 12-TC2-Start From Scratch + add items from multiple lists +Default Loc + Default Category")
	...
	@Test(groups={"SI - WF 13"},priority=1, description = "SI - WF 13-TC1-Start from scratch+ Multiple lists +Custom location + Custom category")
	...
	@Test(groups={"SI - WF 14"},priority=2, description = "SI - WF 14-TC1-Start from scratch+ Multiple lists +Default location + Custom category")
	...
	@Test(groups={"SI - WF 15"},priority=2, description = "SI - WF 15-TC1-Start from scratch+ Multiple lists +Custom location + Default category")
	 ...
	 * Prerequisite:Normal/MA User with OG items
	 */
	@Test(groups={"SI - WF 17"},priority=3, description = "SI - WF 17-TC1-Start from scratch + Multiple lists + Default loc + Skip Category")
	 ...
	 * Prerequisite:Normal/MA User with OG items
	 */
	@Test(groups={"SI - WF 18"},priority=0, description = "SI - WF 18-TC1-Start from scratch+ Multiple lists +skip location + default category")
	 ...
	 */
	@Test(groups={"SI - WF 19"},priority=0, description = "SI - WF 19-TC1-Custom List + default Loc + default Category")
	 ...
	 * 
	 */
	@Test(groups={"SI - WF 20"},priority=0, description = "SI - WF 20-TC1-Custom List + Custom Loc + Custom Category + All items")
	public void SI_WF20_CustomList_CustomLoc_Customcategory_AllItems() {	
		...
		._atLocationsPage()
		.SelectLocation(locationsData3.LocationName, "SI - WF 20-TC1-Selecting nolocation")
		.ItemVerifyOnLocation1("SI - WF 20-TC1-Item verification in nolocation")
		.VerifyDeletedItemsCategory(locationsData3.LocationName,"SI - WF 20-TC1-Item category verification in nolocation")
	 ...
	 * 
	 */
	@Test(groups={"SI - WF 21"},priority=0, description = "SI - WF 21-TC1-Custom List + Custom Loc + Custom Category + Few items")
	...
	@Test(groups={"SI - WF 22"},priority=0, description = "SI - WF 22-TC1-Custom List + Default Loc + custom Category")
	...
	@Test(groups={"SI - WF 23"},priority=0, description = "SI - WF 23-TC1-Custom List + Custom Loc + default Category")
	...
	@Test(groups={"SI - WF 24"},priority=0, description = "SI - WF 24-TC1-Custom List + Skip location+ Skip Category")
	...
	@Test(groups={"SI - WF 25"},priority=0, description = "SI - WF 25-TC1-Custom List+Default loc + Skip Category")
	 ...
	 * 
	 */
	@Test(groups={"SI - WF 27"},priority=0, description = "SI - WF 27-TC1-Custom List + Select Multiple List +List Names+Default Cat")
	 ...
	 * 
	 */
	@Test(groups={"SI - WF 28"},priority=0, description = "SI - WF 28-TC1-Custom List + Select Multiple List +List Names as location+custom Cat")
	 ...
	 * 
	 */
	@Test(groups={"SI - WF 31"},priority=0, description = "SI - WF 31-TC1-Custom List + Select Multiple List +List Names as location+skip Cat")
	 ...
	 * 
	 */
	@Test(groups={"SI - WF 32"},priority=0, description = "SI - WF 32-TC1-Custom List + Select single  List +Custom categories as location+Skip Cat")
	...
	@Test(groups={"SI - WF 33"},priority=4, description = "SI - WF 33-TC1-OG + Default Loc + Suggested Category")
	 ...
	 * 
	 */
	@Test(groups={"SI - WF 36"},priority=0, description = "SI - WF 36-TC1-Custom List + Select Multiple List +List Names+Suggested Cat")
	...
	@Test(groups={"SI - WF 37"},priority=1, description = "SI - WF 37-TC1-Start from scratch+ Multiple lists +Custom location +Suggested category")
	...
	@Test(groups={"SI - WF 38"},priority=2, description = "SI - WF 38-TC1-Start from scratch+ Multiple lists +Default location + Suggested category")
	...
	@Test(groups={"TI-WF1-WF2"},priority=3, description = "TI-WF1-WF2-TC1-Select a location from trackinventory updating quantity and uom")
	...
	@Test(groups={"MIL-WF1-WF4"},priority=0, description = "MIL - WF 1,WF 4-TC2-Creating Location in trackinventory and add items from multiple lists to location")
	...
	@Test(groups={"MIL - WF 2"},priority=1, description = "MIL - WF 2-TC2-Selecing a location, adding same items to multiple location")
	 ...
	 * Prerequisite:Normal/MA User with OG items
	 */
	@Test(groups={"MIL - WF 3"},priority=2, description = "MIL - WF 3-TC2-Selecting a specific location in trackinventory and search for items within location for MA user")
...
;
	 ...
	 * Prerequisite:Normal/MA User with OG items
	 * 
	 */@Test(groups={"MIL - WF 5"},priority=3, description = "MIL - WF 5-TC2-Selecting a location navigate to product and assiging  item  to diff location")
...
@Test(groups={"MIL - WF 6"},priority=4, description = "MIL - WF 6-TC2-Creating Location,Editing Location in Manage Locations and assiging  item  to diff location")
 ...
 */
	 ...
	 */
     ...
     @Test(groups={"MEC - WF 1"},priority=7, description = "MEC - WF 1-TC2-Selecting a location navigate to product and assiging  item  to category created")
	...
	@Test(groups={"MEC - WF 2"},priority=8, description = "MEC - WF 2-TC1-Creating, editing and deleting category ")
	...
	@Test(groups={"MNS-1"},priority=2, description = "MNS-1-TC1-Manage_Create Non-Sysco Item_Link Supplier_Location_Expense Category")
	...
	@Test(groups={"MPI-1"},priority=1, description = "MPI-1-TC1-Manage_Create Prep Item_LinkLocation_Expense Category")
