   	...
   	*/
    	  ...
    	  System.out.println("heading:"+getCommand().getText(Category_Header)); 
   		...
   		if(getCommand().isTargetPresent(OrderGuide_FirstItemSelect))
   		{
   			...
   			System.out.println("OG item "+ItemName1);
 			System.out.println("searched item "+SearchItemName);
 			  final Target keyword1= new Target("keyword1","//*[@class='mm-c-product-minlist__item']//*[contains(text(),'"+ItemName1+"')]/following-sibling::div[@class='mm-c-product-minlist__details']",Target.XPATH); 
				...
				System.out.println(AddedItemId);
     ...
     public SetupInventoryPage verifyOGItemsOnSetupInv(String string) {
         ...
         String finalPath1=GlobalVariable.drivePath+string+string2+GlobalVariable.pathExtension;
          try{
   			...
   			System.out.println("added OG item is: "+SetupInventoryPage.ItemName1);
   			System.out.println("added OG item ID is: "+SetupInventoryPage.AddedItemId1_1[0]);
   		//	 final Target SetUpInventory_1stItemHeading= new Target("OrderGuide_1stItemHeading","//*[@class='mm-c-product-list']//*[@class='Grid__innerScrollContainer']//*[@class='mm-c-product-list__details-wrapper']//*[contains(text(),'"+ItemName+"')]",Target.XPATH); 
   		    final Target SetUpInventory_1stItemHeading= new Target("OrderGuide_1stItemHeading","//*[@class='mm-c-product-list']//*[@class='Grid__innerScrollContainer']//*[@class='mm-c-product-list__details-wrapper']//*[contains(text(),'"+SetupInventoryPage.AddedItemId1_1[0]+"')]",Target.XPATH); 
	...
	if(getCommand().isTargetPresent(Category_Header))
   		{
   			 ...
   			 final Target SetUpInventory_1stItemHeading= new Target("OrderGuide_1stItemHeading","//*[@class='mm-c-product-list']//*[@class='Grid__innerScrollContainer']//*[@class='mm-c-product-list__details-wrapper']//*[contains(text(),'"+SearchItemName+"')]",Target.XPATH); 
...
*/
   		  ...
   		  */	
   				...
   				((IOSDriver)getCommand().driver).findElement(By.xpath("//*[@placeholder='Search']")).sendKeys(Keys.ENTER);
				  ...
				  String string2="Issue";
			       ...
			       String finalPath1=GlobalVariable.drivePath+string+string2+GlobalVariable.pathExtension;
			     	try{
			     		...
			     		getCommand().waitForTargetPresent(SuccessMsg2);System.out.println(getCommand().getText(SuccessMsg2));
			     		getCommand().waitForTargetPresent(SuccessMsg3);System.out.println(getCommand().getText(SuccessMsg3));
...
*/	   	   		//	getCommand().waitForTargetPresent(setupInventryFirstProduct).getText(setupInventryFirstProduct).equalsIgnoreCase(ItemName);
		...
		public SetupInventoryPage SearchKeyword(String string){
				...
				*/	/*
						//by name
						final Target keyword1= new Target("keyword","//*[@class='mm-c-product-list__details-wrapper']//*[contains(text(),'"+ItemName1+"')]/ancestor::div[@class='mm-c-product-list__all-prods']//*[@class='mm-c-product-list__details']",Target.XPATH); 
						...
						*/
						...
						System.out.println("itmname"+ItemName1);
						
						/*final Target keyword1= new Target("keyword","(//*[@class='mm-c-product-list__details-wrapper']//*[contains(text(),'"+ItemName1+"')]/ancestor::div[@class='mm-c-product-list__all-prods']//*[@class='mm-c-product-list__description'])/h6",Target.XPATH); 
						System.out.println("targetgot");
						keyword=getCommand().getText(keyword1);
						System.out.println("search item "+keyword);
					
						 searchKeyword=keyword.split("\\s+");
						System.out.println("searching keyword"+searchKeyword[0]);
	...
	public SetupInventoryPage verifyKeywordSearchItems(String string) {
		...
		*/	/*//by name
			 final Target SearchCheck= new Target("SearchCheck","//*[@class='mm-c-product-list']//*[@class='Grid__innerScrollContainer']//*[@class='mm-c-product-list__details-wrapper']//*[contains(text(),'"+searchKeyword[0]+"')]",Target.XPATH); 
		   */		
			
			//by id
		// final Target SearchCheck= new Target("SearchCheck","//*[@class='mm-c-product-list__all-prods']//*[@class='mm-c-product-list__row-wrapper']//*[@class='mm-c-product-list__description']//*[contains(text(),'"+searchKeyword[0]+"')]",Target.XPATH); 
     	  ...
     	  System.out.println("heading:"+getCommand().getText(Category_Header)); 
    		...
    		if(getCommand().isTargetPresent(OrderGuide_FirstItemSelect))
    		{
   			...
   			final Target keyword1= new Target("keyword1","//*[@class='mm-c-product-minlist__item']//*[contains(text(),'"+SearchItemName+"')]/following-sibling::div[@class='mm-c-product-minlist__details']",Target.XPATH); 
				...
				System.out.println(AddedItemId1[0]);
    	 	...
    	 	//getCommand().captureScreenshot(finalPath); 
    		...
    		else
	   		{
	   		 ...
	   		 ((IOSDriver)getCommand().driver).context("NATIVE_APP"); 
	    	  	...
	    	  	((IOSDriver)getCommand().driver).context((String) contextNames1.toArray()[1]);
