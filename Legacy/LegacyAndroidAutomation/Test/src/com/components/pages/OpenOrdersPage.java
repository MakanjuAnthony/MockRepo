...
//	public static final Target OpenOrdersPage_OpenedItem_NU =new Target("OpenOrdersPage_OpenedItem_NU","//*[@class='main-content']//*[@class='page-body']//*[@class='orders']//*[@class='order']//*[@data-order-status='Open'and @data-order-id='1020650']",Target.XPATH);
	...
	public static final Target OpenOrdersPage_PendingApproval_NU =new Target("OpenOrdersPage_PendingApproval_NU","(//*[@class='main-content']//*[@class='page-body']//*[@class='orders']//*[@class='order']//*[@data-order-status='Pending approval'])[80]//i",Target.XPATH);
...
getCommand().waitFor(10);
	...
	
	{
		...
		getCommand().waitFor(10);
			...
			((AndroidDriver)getCommand().driver).context("NATIVE_APP");
			String finalPath1=drivePath+"openItem_ClickWeb"+"Fail"+pathExtension;
			getCommand().captureScreenshot(finalPath1);
