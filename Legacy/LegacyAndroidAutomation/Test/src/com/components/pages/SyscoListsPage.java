...
//	(//*[@class='main-content']//*[@class='page-body']//*[@class='list-options']//a)[1]
	...
	public static final Target itemsInsideSyscoList_PlusButton1=new Target("itemsInsideSharedList_PlusButton ","//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.webkit.WebView[1]/android.webkit.WebView[1]/android.view.View[10]/android.view.View[6]/android.view.View[1]/android.view.View[1]/android.view.View[3]/android.view.View[1]",Target.XPATH);
...
getCommand().waitFor(10);
			...
			((AndroidDriver)getCommand().driver).context("NATIVE_APP");
			String finalPath1=drivePath+"syscoListItem_Click"+"Fail"+pathExtension;
...
//		Target target= itemsInsideSyscoList_PlusButton2;
		...
		if (getCommand().isTargetPresent(target))
		{
			...
			((AndroidDriver)getCommand().driver).context("NATIVE_APP");
			String finalPath1=drivePath+"syscoListPlusBtn_Click"+"Fail"+pathExtension;
			getCommand().captureScreenshot(finalPath1);
	...
	public SyscoListsPage syscoLists_CreateClick() 
	{
		...
		{	getCommand().waitFor(10);
			...
			((AndroidDriver)getCommand().driver).context("NATIVE_APP");
			String finalPath1=drivePath+"syscoLists_CreateClick"+"Fail"+pathExtension;
			getCommand().captureScreenshot(finalPath1);
	...
	public SyscoListsPage syscoLists_CartClick() 
	{
		...
		{	getCommand().waitFor(10);
			...
			((AndroidDriver)getCommand().driver).context("NATIVE_APP");
			String finalPath1=drivePath+"syscoLists_CartClick"+"Fail"+pathExtension;
			getCommand().captureScreenshot(finalPath1);
