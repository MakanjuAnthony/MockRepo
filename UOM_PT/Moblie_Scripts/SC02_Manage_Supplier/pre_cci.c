# 1 "e:\\uom\\mobility scripts\\final\\sc02_manage_supplier\\\\combined_SC02_Manage_Supplier.c"
...
# 1 "e:\\uom\\mobility scripts\\final\\sc02_manage_supplier\\\\combined_SC02_Manage_Supplier.c" 2
...
# 2 "e:\\uom\\mobility scripts\\final\\sc02_manage_supplier\\\\combined_SC02_Manage_Supplier.c" 2
...
# 3 "e:\\uom\\mobility scripts\\final\\sc02_manage_supplier\\\\combined_SC02_Manage_Supplier.c" 2
...
# 4 "e:\\uom\\mobility scripts\\final\\sc02_manage_supplier\\\\combined_SC02_Manage_Supplier.c" 2
...
# 47 "Action.c"
	...
	if(strcmp(lr_eval_string("{Corr_CustomerID1}"),"")==0)
    {
		...
		lr_end_transaction("SC02_01A_Supplier_Create_Account", 2);
	...
	countIDs=atoi(lr_eval_string("{Corr_Supplier_count}"));
		...
		if (HttpRetCode == 200)
		{
			lr_end_transaction("SC02_02_Supplier_Click_on_Suppliers",0);
		}
		else
		{
			lr_end_transaction("SC02_02_Supplier_Click_on_Suppliers",1);
		}
...
for(j=1;j<=4;j++)
{
	...
	{ 	lr_end_transaction("SC02_03_Supplier_Add_Supplier",1); 	}

	else
	{	lr_end_transaction("SC02_03_Supplier_Add_Supplier",0); 	
		...
		web_custom_request("SupplierDetails",
			...
			if(strcmp(lr_eval_string("{Corr_SupplierGetID}"),"")==0)
			{ 	lr_end_transaction("SC02_04_Supplier_Get_Suppliers_Details",1); 	}
			else
			{	lr_end_transaction("SC02_04_Supplier_Get_Suppliers_Details",0); 	}
	}
}
...
if(atoi(lr_eval_string("{Corr_SupplierU_count}"))>1)
{
	...
	lr_start_transaction("SC02_05_Supplier_Edit_Supplier");
		...
		lr_end_transaction("SC02_05_Supplier_Edit_Supplier", 2);
	...
	lr_end_transaction("SC02_06_Supplier_Delete_Supplier", 2); 
}
else
{
	lr_end_transaction("SC02_02_Supplier_Click_on_Suppliers",1);
...
# 5 "e:\\uom\\mobility scripts\\final\\sc02_manage_supplier\\\\combined_SC02_Manage_Supplier.c" 2
...
# 6 "e:\\uom\\mobility scripts\\final\\sc02_manage_supplier\\\\combined_SC02_Manage_Supplier.c" 2
