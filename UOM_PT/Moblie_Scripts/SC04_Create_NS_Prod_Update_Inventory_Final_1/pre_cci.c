# 1 "e:\\uom\\mobility scripts\\final\\sc04_create_ns_prod_update_inventory_final_1\\\\combined_SC04_Create_NS_Prod_Update_Inventory_Final_1.c"
...
# 1 "e:\\uom\\mobility scripts\\final\\sc04_create_ns_prod_update_inventory_final_1\\\\combined_SC04_Create_NS_Prod_Update_Inventory_Final_1.c" 2
...
# 2 "e:\\uom\\mobility scripts\\final\\sc04_create_ns_prod_update_inventory_final_1\\\\combined_SC04_Create_NS_Prod_Update_Inventory_Final_1.c" 2
...
# 3 "e:\\uom\\mobility scripts\\final\\sc04_create_ns_prod_update_inventory_final_1\\\\combined_SC04_Create_NS_Prod_Update_Inventory_Final_1.c" 2
...
# 4 "e:\\uom\\mobility scripts\\final\\sc04_create_ns_prod_update_inventory_final_1\\\\combined_SC04_Create_NS_Prod_Update_Inventory_Final_1.c" 2
...
{	
	...
	if ((InvbodyP1 = (char *)calloc(99999, sizeof(char))) == 0) {

        lr_output_message ("Insufficient memory available");
        return -1;
    }
	
	if ((InvbodyP2 = (char *)calloc(99999, sizeof(char))) == 0) {
...
CreateAccount:
	...
	lr_end_transaction("SC04_02_Create_NS_Prod_Update_Inventory_Create_New_Account", 2);
...
CreateInventory:
	...
	lr_end_transaction("SC04_03_Create_NS_Prod_Update_Inventory_Create_Supplier",2);	
	...
	for (i=0;i<count;i++) 
	{
		...
		lr_end_transaction("SC04_04_Create_NS_Prod_Update_Inventory_Add_Non_Sysco_Items",2);
		...
		{									 
			...
			lr_end_transaction("SC04_05_Create_NS_Prod_Update_Inventory_Add_From_Scratch", 2);
			...
			lr_end_transaction("SC04_06_Create_NS_Prod_Update_Inventory_CreateFirstLocation", 2);
			...
			lr_end_transaction("SC04_07_Create_NS_Prod_Update_Inventory_CreateExpenseCategoryFood", 2);
		...
		{	
			if(i==10)
			{
				...
				web_custom_request("groups", 
					...
					"LAST");
				lr_end_transaction("SC04_08_Create_NS_Prod_Update_Inventory_CreateNewLocation", 2);
			}
			...
			lr_end_transaction("SC04_09_Create_NS_Prod_Update_Inventory_UpdateInventoryWithNewItem", 2);
			...
			lr_end_transaction("SC04_10_Create_NS_Prod_Update_Inventory_GetCurrentInventory", 2);
...
# 5 "e:\\uom\\mobility scripts\\final\\sc04_create_ns_prod_update_inventory_final_1\\\\combined_SC04_Create_NS_Prod_Update_Inventory_Final_1.c" 2
...
# 6 "e:\\uom\\mobility scripts\\final\\sc04_create_ns_prod_update_inventory_final_1\\\\combined_SC04_Create_NS_Prod_Update_Inventory_Final_1.c" 2
