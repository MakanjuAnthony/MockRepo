# 1 "g:\\11_uom\\scripts\\qa\\sprint5\\s08_create_inventory_withsysco_products\\\\combined_S08_Create_Inventory_WithSysco_Products.c"
...
# 1 "g:\\11_uom\\scripts\\qa\\sprint5\\s08_create_inventory_withsysco_products\\\\combined_S08_Create_Inventory_WithSysco_Products.c" 2
...
# 2 "g:\\11_uom\\scripts\\qa\\sprint5\\s08_create_inventory_withsysco_products\\\\combined_S08_Create_Inventory_WithSysco_Products.c" 2
...
# 3 "g:\\11_uom\\scripts\\qa\\sprint5\\s08_create_inventory_withsysco_products\\\\combined_S08_Create_Inventory_WithSysco_Products.c" 2
...
# 4 "g:\\11_uom\\scripts\\qa\\sprint5\\s08_create_inventory_withsysco_products\\\\combined_S08_Create_Inventory_WithSysco_Products.c" 2
...
Action()
{
	...
	lr_end_transaction("WS08_00_Get_AccountByCustomerID", 2);
...
{	
	...
	lr_end_transaction("WS08_01_GetGroups", 2);
...
for (i=1;i<=5;i++) 
{
	...
	lr_end_transaction("WS08_02_Create_Groups", 2);
...
for (i=0;i<=29;i++) {
	...
	lr_end_transaction("WS08_03_Get_Product_By_Product_ID", 2);
...
if(strcmp(lr_eval_string("{Corr_MaterialID}"),"")==0)
{
	...
	lr_end_transaction("WS08_04_Create_New_Inventory", 2);
	...
	lr_end_transaction("WS08_05_Get_Current_Open_Inventory", 2);
...
# 5 "g:\\11_uom\\scripts\\qa\\sprint5\\s08_create_inventory_withsysco_products\\\\combined_S08_Create_Inventory_WithSysco_Products.c" 2
...
# 6 "g:\\11_uom\\scripts\\qa\\sprint5\\s08_create_inventory_withsysco_products\\\\combined_S08_Create_Inventory_WithSysco_Products.c" 2
