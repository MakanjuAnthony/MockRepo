# 1 "g:\\11_uom\\scripts\\qa\\sprint5\\s03_create_nonsysco_products_final\\\\combined_S03_Create_NonSysco_Products_Final.c"
...
# 1 "g:\\11_uom\\scripts\\qa\\sprint5\\s03_create_nonsysco_products_final\\\\combined_S03_Create_NonSysco_Products_Final.c" 2
...
# 2 "g:\\11_uom\\scripts\\qa\\sprint5\\s03_create_nonsysco_products_final\\\\combined_S03_Create_NonSysco_Products_Final.c" 2
...
# 3 "g:\\11_uom\\scripts\\qa\\sprint5\\s03_create_nonsysco_products_final\\\\combined_S03_Create_NonSysco_Products_Final.c" 2
...
# 4 "g:\\11_uom\\scripts\\qa\\sprint5\\s03_create_nonsysco_products_final\\\\combined_S03_Create_NonSysco_Products_Final.c" 2
...
int i=0;
	...
	lr_end_transaction("WS03_00_Get_AccountByCustomerID", 2);
...
if(strcmp(lr_eval_string("{Corr_SupplierID_1}"),"")==0)
{
	...
	lr_end_transaction("WS03_01_Get_ListOfSuppliers", 2);
}
...
for (i=1;i<=10;i++)
{
	...
	lr_end_transaction("WS03_03_Get_Product_By_Product_ID", 2);
	...
	lr_end_transaction("WS03_04_Get_NonSysco_ListOfProducts", 2);
	...
	lr_end_transaction("WS03_05_Update_NonSysco_Product", 2);
	...
	web_custom_request("DeleteNonSyscoProduct",
 	...
 	lr_end_transaction("WS03_06_Delete_NonSysco_Product", 2); 
...
for(i=1;i<=5;i++)
{
	...
	lr_end_transaction("WS03_07_Get_SyscoProducts", 2);
}
...
# 5 "g:\\11_uom\\scripts\\qa\\sprint5\\s03_create_nonsysco_products_final\\\\combined_S03_Create_NonSysco_Products_Final.c" 2
...
# 6 "g:\\11_uom\\scripts\\qa\\sprint5\\s03_create_nonsysco_products_final\\\\combined_S03_Create_NonSysco_Products_Final.c" 2
