# 1 "g:\\11_uom\\scripts\\qa\\sprint5\\s04_create_inventory_integrated_final_exp_category\\\\combined_S04_Create_Inventory_Integrated_Final_Exp_Category.c"
...
# 1 "g:\\11_uom\\scripts\\qa\\sprint5\\s04_create_inventory_integrated_final_exp_category\\\\combined_S04_Create_Inventory_Integrated_Final_Exp_Category.c" 2
...
# 2 "g:\\11_uom\\scripts\\qa\\sprint5\\s04_create_inventory_integrated_final_exp_category\\\\combined_S04_Create_Inventory_Integrated_Final_Exp_Category.c" 2
...
char Supplier_ID_x[50];
char SupplierName_x[50];
char DeleteStatus_x[50];
int i;
int TT = 10;
char temp[250];
long fp;

char Product_ID_x[50];
char ProductName_x[50];
char UPC_x[50];
char Supplier_x[50];
char DeleteStatus_x[50];
char Brand_x[50];
...
char ProductID_Inv[50];

char Inventory_ID_x[50];
char ClosedDate_x[50];
int i;
...
# 3 "g:\\11_uom\\scripts\\qa\\sprint5\\s04_create_inventory_integrated_final_exp_category\\\\combined_S04_Create_Inventory_Integrated_Final_Exp_Category.c" 2
...
# 4 "g:\\11_uom\\scripts\\qa\\sprint5\\s04_create_inventory_integrated_final_exp_category\\\\combined_S04_Create_Inventory_Integrated_Final_Exp_Category.c" 2
...
Action()
{
	...
	lr_start_transaction("WS04_00_Get_AccountByCustomerID");
	...
	lr_end_transaction("WS04_00_Get_AccountByCustomerID", 2);
...
CreateData:
	...
	lr_end_transaction("WS01_02_Create_Groups", 2);
...
for (i=1;i<=5;i++) 
{
	...
	lr_end_transaction("WS01_04_Create_New_Suppliers", 2);
}
	...
	lr_end_transaction("WS02_05_Get_ListOfSuppliers", 2);  
...
for (i=1;i<=20;i++) 
{
	...
	lr_end_transaction("WS03_02_Insert_NonSysco_Product", 2);
	...
	lr_start_transaction("WS04_04_Create_New_Inventory");
	...
	lr_end_transaction("WS04_04_Create_New_Inventory", 2);
	...
	lr_start_transaction("WS04_05_Get_Current_Open_Inventory");
	...
	lr_end_transaction("WS04_05_Get_Current_Open_Inventory", 2);
...
# 5 "g:\\11_uom\\scripts\\qa\\sprint5\\s04_create_inventory_integrated_final_exp_category\\\\combined_S04_Create_Inventory_Integrated_Final_Exp_Category.c" 2
...
# 6 "g:\\11_uom\\scripts\\qa\\sprint5\\s04_create_inventory_integrated_final_exp_category\\\\combined_S04_Create_Inventory_Integrated_Final_Exp_Category.c" 2
