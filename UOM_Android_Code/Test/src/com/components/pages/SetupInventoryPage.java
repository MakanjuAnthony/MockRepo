 ...
 VendorPage vp=new VendorPage(repository);					  
  public SetupInventoryPage(SiteRepository repository)
	...
	if(getCommand().isTargetPresent(Category_Header))
  		...
  		//	 final Target SetUpInventory_1stItemHeading= new Target("OrderGuide_1stItemHeading","//*[@class='mm-c-product-list']//*[@class='Grid__innerScrollContainer']//*[@class='mm-c-product-list__details-wrapper']//*[contains(text(),'"+SetupInventoryPage.CatalogAddedItemId1[0]+"')]",Target.XPATH); 
	    	    ...
	    	    public SetupInventoryPage verifyMultipleItemsfromOGonSetUpInv(String string) {
				       ...
				       try{
	    	        	  ...
	    	        	  System.out.println(AddedItemId1_3[0]);
	    	   		    ...
	    	   		    System.out.println("noelements:"+noOfElements);
		...
		public SetupInventoryPage SearchKeyword(String string){
					...
					try{
						...
						*/
						...
						/*final Target keyword1= new Target("keyword","//*[@class='mm-c-product-list__details-wrapper']//*[contains(text(),'"+ItemName1+"')]/ancestor::div[@class='mm-c-product-list__all-prods']//*[@class='mm-c-product-list__description']",Target.XPATH); 
   	...
   	if(getCommand().isTargetPresent(Category_Header))
  		{
  			...
  			if (ItemName!=null){
  			System.out.println("inside OG item verification"+ItemName);
  			
  			// final Target SetUpInventory_1stItemHeading= new Target("OrderGuide_1stItemHeading","//*[@class='mm-c-product-list']//*[@class='Grid__innerScrollContainer']//*[@class='mm-c-product-list__details-wrapper']//*[contains(text(),'"+SetupInventoryPage.ItemName+"')]",Target.XPATH); 
