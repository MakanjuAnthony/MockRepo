...
public class LocationsPage extends SitePage{
   ...
   // public static final Target Done= new Target("Done","//*[@id='done-nav']/a",Target.XPATH);
    ...
    public static final Target Location_FirstItemSelect= new Target("LocationName","(//*[@class='mm-c-product-list__details'])[1]/h4",Target.XPATH);
    ...
    public static String Location1ItemAdded;
 	//public static final Target Location_FirstItemAdded= new Target("LocationName","//*[@id='mount']/div/div/div[2]/div/div/div[2]/div[1]/div/div/div/div/div/div[3]/div[1]/div[2]/h4",Target.XPATH);
 	
 		 	public static final Target Location_FirstItemAdded= new Target("LocationName","(//*[@id='mount']/div/div/div[2]/div/div/div[2]/div[1]/div/div/div/div/div/div[3]/div[1]/div[2]/h4)[1]",Target.XPATH);
...
*/
	 ...
	 public static final Target LocType_Dry2 = new Target("LocationName","(//*[@id='storage'])[3]",Target.XPATH);
	 public static final Target LocType_Dry2T1 = new Target("LocationName","(//*[@id='storage'])[3]",Target.XPATH);
	 public static final Target LocType_Dry2T2 = new Target("LocationName","(//*[@id='storage'])[3]",Target.XPATH);
      ...
      public  LocationsPage ItemVerifyOnLocation(String location,String string){
    		...
    		String string2="Issue";	
    		  ...
    		  String finalPath1=LoginPage.drivePath+string+string2+pathExtension;
    			...
    			final Target Locations_Productcheck= new Target("Locations_check","//*[@class='mm-c-product-list__details-wrapper']//*[contains(text(),'"+Location1ItemAdded+"')]",Target.XPATH);
...
//    				 final Target Locations_random1= new Target("Locations_random1","//*[@id='list-item' and contains(text(),'{0}')]",Target.XPATH);
    				 final Target Locations_random1= new Target("Locations_random1","//*[@id='list-item']//*[contains(text(),'"+location+"')]",Target.XPATH);
...
//    			getCommand().click(Locations_random1.format(location));
    		   ...
    		   // System.out.println("got back");
    		    getCommand().waitForTargetPresent(Done, 5).click(Done);
...
*/
  ...
  */  	   			getCommand().clear(AddLocation_LocName);
    ...
    System.out.println(((IOSDriver)getCommand().driver).context((String) contextNames.toArray()[1]));*/	
    	   		    ...
    	   		    getCommand().clickWithJavascript(AddLocation_LocTypeCooler);
    	   		    System.out.println("selected cooler");
