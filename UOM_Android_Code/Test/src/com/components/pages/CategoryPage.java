...
public class CategoryPage extends SitePage{
	...
	String pathExtension=".png";
	 public static final Target takeHome = new Target("takeHome","//*[@id='mount']/div/div/div[2]/div/button",Target.XPATH);
		...
		//////////////
			...
			//	public static final Target ExpenseCategory_Food1= new Target("ExpenseCategory_Food1","//*[@id='food1']",Target.XPATH); 
				...
				//	public static final Target Category_Header= new Target("Category_Header","//UIAApplication[1]/UIAWindow[1]/UIAScrollView[1]/UIAWebView[1]/UIAStaticText[8]",Target.XPATH);
				 ...
				 public static final Target  ExpenseCategories = new Target("ExpenseCategories","//*[@class='btn btn-sm btn-primary' and contains(text(),'Create Expense Cat.')]",Target.XPATH);
	...
	public CategoryPage CreateExpenseCategories(String string)
	{
		log("Selecting custom category from Food cost page",LogType.STEP);
	...
	public CategoryPage tabTakemeHome(String string) {
		
		try{
     		
			
			getCommand().waitForTargetPresent(takeHome);
			getCommand().click(takeHome);
					
			
			log("Tapped on Take me Home :Pass",LogType.VERIFICATION_STEP);
		}
...
*/
	  ...
	  public CategoryPage SelectItemFromCategory(String name,String string) { 
	    	...
	    	String finalPath3=LoginPage.drivePath+string+string4+pathExtension;
	    	try{ 
